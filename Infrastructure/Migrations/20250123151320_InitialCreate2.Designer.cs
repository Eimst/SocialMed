...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250123151320_InitialCreate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Friend", b =>
                {
                    b.HasOne("Core.Entities.UserProfile", "Requester")
                        .WithMany("SentFriendRequests")
                        .HasForeignKey("RequesterId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Core.Entities.UserProfile", "Responder")
            ...
            modelBuilder.Entity("Core.Entities.Message", b =>
                {
                    b.HasOne("Core.Entities.UserProfile", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Core.Entities.UserProfile", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Entities.Notification", b =>
                {
                    b.HasOne("Core.Entities.UserProfile", "Initiator")
                        .WithMany()
